      ...
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 px-4">
        <div className="flex flex-1 justify-start items-start flex-col mf:mr-10">
          <h1 className="text-3xl sm:text-5xl text-white text-gradient py-1">
            Retire Smart <br /> Retire Well <br /> PensionFi
          </h1>
          ...
          <div className="p-3 flex justify-end items-start flex-col rounded-xl h-80 sm:w-120 w-full my-5 eth-card .white-glassmorphism ">
